...
if __name__ == '__main__':
    ...
    sample_input = torch.randn(args.batch_size, args.img_size[0], args.img_size[1], args.img_size[2]).to(args.device)
    ...
    assert np.allclose(
        ...
        atol=1.e-2), 'The outputs are different (Pytorch and ONNX)'
